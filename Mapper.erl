...
['slot-id',{HLKEY},'device',['http://tail-f.com/ns/example/hldevices'|'devices']] ->
	#mappings{path=['slot-id',{LLKEY},'lldevice',['http://tail-f.com/ns/example/lldevices'|'lldevices']]};
['card-type',{HLKEY},'device',['http://tail-f.com/ns/example/hldevices'|'devices']] ->
	#mappings{path=['card-type',{LLKEY},'lldevice',['http://tail-f.com/ns/example/lldevices'|'lldevices']],get_elem=fun get_elem_card_type_enum_TO_string/3,set_elem=fun set_elem_card_type_enum_TO_string/3};
